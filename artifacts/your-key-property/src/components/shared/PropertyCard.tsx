...
export function PropertyCard({ id = "1", image, status, price, title, location, beds, baths, sqft }: PropertyCardProps) {
  return (
    <div className="group bg-white border border-border overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 flex flex-col h-full">
