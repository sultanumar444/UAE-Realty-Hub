...
- [Off-plan map embed safety](offplan-map-embed.md) — buildMapSrc only frames a pasted URL verbatim when host is Google; else degrades to a search-query embed.
