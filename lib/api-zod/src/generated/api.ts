...
export const ListOffPlanProjectsResponseItem = zod.object({
  ...
  "numberOfBuildings": zod.string().nullish(),
  "propertyTypes": zod.string().nullish(),
  "governmentFee": zod.string().nullish(),
  "ownershipType": zod.string().nullish(),
  "bedrooms": zod.string().nullish(),
  "unitTypes": zod.string().nullish(),
  "brochureUrl": zod.string().nullish(),
  "floorPlanPdf": zod.string().nullish(),
  "brochurePdf": zod.string().nullish(),
  "seoTitle": zod.string().nullish(),
  "seoDescription": zod.string().nullish(),
  "featured": zod.boolean(),
  "status": zod.string(),
...
export const CreateOffPlanProjectBody = zod.object({
  ...
  "numberOfBuildings": zod.string().optional(),
  "propertyTypes": zod.string().optional(),
  "governmentFee": zod.string().optional(),
  "ownershipType": zod.string().optional(),
  "bedrooms": zod.string().optional(),
  "unitTypes": zod.string().optional(),
  "brochureUrl": zod.string().optional(),
  "floorPlanPdf": zod.string().optional(),
  "brochurePdf": zod.string().optional(),
  "seoTitle": zod.string().optional(),
  "seoDescription": zod.string().optional(),
  "featured": zod.boolean().optional(),
  "status": zod.string().optional()
