  ...
  const allProjects = [
    {
      ...
      mapUrl: "https://www.google.com/maps?q=Yas+Bay,+Yas+Island,+Abu+Dhabi&output=embed",
      agentId: priya ?? saeed,
    ...
    },
    {
      ...
      mapUrl: "https://www.google.com/maps?q=Dubai+Marina,+Dubai&output=embed",
      agentId: priya ?? saeed,
    ...
    },
    {
      ...
      mapUrl: "https://www.google.com/maps?q=Saadiyat+Island,+Abu+Dhabi&output=embed",
      agentId: saeed ?? priya,
